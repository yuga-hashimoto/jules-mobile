...
const resources = {
  en: {
    translation: {
      ...
      optional: 'optional',
      sessionTitlePlaceholder: 'e.g., Fix login bug',
      promptHelper: 'Be specific for better results',
      options: 'Options',
      autoCreatePR: 'Auto-create PR',
      autoCreatePRDescription: 'Automatically create a pull request when finished',
      requirePlanApproval: 'Require plan approval',
      requirePlanApprovalDescription: 'Review the plan before execution starts',
      deleteSession: 'Delete Session',
      deleteSessionConfirm: 'Are you sure you want to delete "{{title}}"?',
      delete: 'Delete',
      deleteFailed: 'Delete failed',
      viewDetails: 'View Details',
      loadAllActivities: 'Load all activities',
      openInWeb: 'Open in Jules Web',
  ...
  ja: {
    translation: {
      ...
      optional: '任意',
      sessionTitlePlaceholder: '例: ログインのバグ修正',
      promptHelper: 'より良い結果のために具体的に記述してください',
      options: 'オプション',
      autoCreatePR: '自動PR作成',
      autoCreatePRDescription: '完了時に自動的にプルリクエストを作成します',
      requirePlanApproval: 'プラン承認が必要',
      requirePlanApprovalDescription: '実行開始前にプランを確認します',
      deleteSession: 'セッション削除',
      deleteSessionConfirm: '"{{title}}" を削除してもよろしいですか？',
      delete: '削除',
      deleteFailed: '削除に失敗しました',
      viewDetails: '詳細を表示',
      loadAllActivities: 'すべてのアクティビティを読み込む',
      openInWeb: 'Jules Webで開く',
  ...
  ko: {
    translation: {
      ...
      selectBranch: '브랜치 선택',
      optional: '선택사항',
      sessionTitlePlaceholder: '예: 로그인 버그 수정',
      promptHelper: '더 나은 결과를 위해 구체적으로 작성하세요',
      options: '옵션',
      autoCreatePR: '자동 PR 생성',
      autoCreatePRDescription: '완료 시 자동으로 풀 리퀘스트를 생성합니다',
      requirePlanApproval: '계획 승인 필요',
      requirePlanApprovalDescription: '실행 시작 전에 계획을 검토합니다',
      deleteSession: '세션 삭제',
      deleteSessionConfirm: '"{{title}}"을(를) 삭제하시겠습니까?',
      delete: '삭제',
      deleteFailed: '삭제 실패',
      viewDetails: '상세 보기',
      loadAllActivities: '모든 활동 로드',
      openInWeb: 'Jules 웹에서 열기',
  ...
  zh: {
    translation: {
      ...
      selectBranch: '选择分支',
      optional: '可选',
      sessionTitlePlaceholder: '例如：修复登录错误',
      promptHelper: '为了获得更好的结果，请详细描述',
      options: '选项',
      autoCreatePR: '自动创建 PR',
      autoCreatePRDescription: '完成后自动创建拉取请求',
      requirePlanApproval: '需要计划批准',
      requirePlanApprovalDescription: '在执行开始前审查计划',
      deleteSession: '删除会话',
      deleteSessionConfirm: '确定要删除"{{title}}"吗？',
      delete: '删除',
      deleteFailed: '删除失败',
      viewDetails: '查看详情',
      loadAllActivities: '加载所有活动',
      openInWeb: '在 Jules Web 中打开',
