...
const resources = {
  en: {
    translation: {
      ...
      apiKeyHelp: 'Get your API key from Google Cloud Console.',
  ...
  ja: {
    translation: {
      ...
      apiKeyHelp: 'Google Cloud ConsoleからAPIキーを取得してください。',
  ...
  ko: {
    translation: {
      ...
      showLess: '접기',
      moreSteps: '단계 더 보기',
      apiKeyHelp: 'Google Cloud Console에서 API 키를 가져오세요.',
  ...
  zh: {
    translation: {
      ...
      showLess: '收起',
      moreSteps: '更多步骤',
      apiKeyHelp: '从 Google Cloud Console 获取您的 API 密钥。',
      openCode: '打开此屏幕的代码：',
